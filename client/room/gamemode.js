...
Teams.Add("Blue", "<b><i><||•Игроки•||>[Сложность:<color=Blue>КЛАССИКА</a><i></b>", new Color(0, 0, 1, 0));
...
Teams.Get("Blue").Properties.Get("Deaths").Value = "<b><i>Создал <color=red>BOSS</color>!!!</i></b>";

LeaderBoard.PlayerLeaderBoardValues = [
  new DisplayValueHeader("Kills", "<b><i>Киллы</i></b>"),
  new DisplayValueHeader("Deaths", "<b><i>Смерти</i></b>"),
  new DisplayValueHeader("Scores", "<b><i>Очки</i></b>"),
  new DisplayValueHeader("Status", "<b><i>Статус</i></b>")
];
